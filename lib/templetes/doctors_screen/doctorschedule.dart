          ...
          children: [
            SizedBox(
              ...
              child:
                ...
                final doctorsSchedule = controller.getList.where((element) =>
                    element.doctorID == FirebaseAuth.instance.currentUser!.uid);

                return Obx(() => scheduleController.isLoading.value
                    ? const Center(
